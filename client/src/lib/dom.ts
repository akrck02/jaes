...
export function uiComponent(properties: UIProperties): HTMLElement {
  ...
  if (undefined != properties.id) element.id = properties.id;
...
export function setDomAttributes(
  ...
  if (undefined == element || undefined == attributes) return element;
...
export function removeDomAttributes(
  element: HTMLElement,
  attributes: string[]
): HTMLElement {
  if (undefined == element || undefined == attributes) return element;

  for (const attr of attributes) element.removeAttribute(attr);

  return element;
}

/** Set DOM classes */
export function setDomClasses(
  element: HTMLElement,
  classes: string[]
): HTMLElement {
  if (undefined == element || undefined == classes) return element;
...
/** Set DOM classes */
export function removeDomClasses(
  element: HTMLElement,
  classes: string[]
): HTMLElement {
  if (undefined == element || undefined == classes) return element;
...
/** Set DOM styles */
export function setDomStyles(
  element: HTMLElement,
  styles: { [key: string]: string }
): HTMLElement {
  if (undefined == element || undefined == styles) return element;
...
/** Remove DOM styles */
export function removeDomStyles(
  element: HTMLElement,
  styles: string[]
): HTMLElement {
  if (undefined == element || undefined == styles) return element;

  for (const style in styles) element.style.removeProperty(style);

  return element;
}

/** Set DOM events*/
export function setDomEvents(
  element: HTMLElement,
  events: { [key: string]: (event: Event) => void }
): HTMLElement {
  if (undefined == element || undefined == events) return element;
...
/** Set DOM dataset */
export function setDomDataset(
  element: HTMLElement,
  dataset: { [key: string]: string }
): HTMLElement {
  if (undefined == element || undefined == dataset) return element;
...
/** Remove DOM dataset */
export function removeDomDataset(
  element: HTMLElement,
  dataset: string[]
): HTMLElement {
  if (undefined == element || undefined == dataset) return element;
...
export function removeAllDomBySelector(selector: string): number {
  if (undefined == selector) return 0;

  const elements = document.querySelectorAll(selector);
  if (undefined == elements) return 0;
